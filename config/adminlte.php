...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'Zona de gimnasio'],
        [
            'text' => 'Categorias',
            'url' => 'gimnasio/categorias',
            'icon' => 'fas fa-layer-group',
        ],
        [
            'text' => 'Promociones',
            'url' => 'gimnasio/promociones',
            'icon' => 'fas fa-tag',
        ],
        [
            'text' => 'Métodos de pago',
            'url' => 'gimnasio/metodos',
            'icon' => 'fas fa-wallet',
        ],
        [
            'text' => 'Clientes',
            'url' => 'gimnasio/clientes',
            'icon' => 'fas fa-users',
        ],
        [
            'text' => 'Inscripciones',
